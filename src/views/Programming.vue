					...
					<div class="card content-card" v-if="!loading && theme">
						...
						<Accordion :value="['0']" multiple>
							...
							<AccordionPanel value="1">
								...
								<AccordionContent>
									<MonacoEditor class="code-block" :language="selectedLanguage?.value"
							...
							<AccordionPanel value="2">
								...
								<AccordionContent>
									...
									<MonacoEditor class="code-block" :language="selectedLanguage?.value"
									              v-model="codeSnippet" :readonly="false"/>
									<Button class="check-button p-button-warning p-mt-2" type="button" label="Check"
									        icon="pi pi-check" :loading="checkLoading" @click="checkExercise"/>
								</AccordionContent>
							</AccordionPanel>
						</Accordion>
					</div>
